...
<script language="javascript"><!--
	...
	function getGeCodeType(){
		...
		if(confirm("确定关联该供应商?")){
			var objTemp = idStr.split("@");
			top.opener.document.getElementsByName("thirdParterName")[0].value = objTemp[1];
			top.opener.document.getElementsByName("geThirdParterService.geThirdParterInfo.thirdParterID")[0].value = objTemp[0];
			top.close();
		}
	}
	//特殊处理end
