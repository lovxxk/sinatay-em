...
<body topmargin="0" leftmargin="0">
	...
	供应商维护<span id="des" style="cursor: pointer;font-size: 15px;"><img style="vertical-align:middle;color:#E9E7E8" src="${ctx}/global/images/help.png"/></span>
	</div>
	<div class="table_content">
		<form id="frmInput"  method="post" action="${ctx}/party/findThirdParterInfo.do?opertion=normal" target="fraSearchList">
			<table class="table_style" style="width:750px">
				<tr>
					...
					<td class="td_body">
						<input type="text"  name="geThirdParterInfo.thirdParterName" style="width:150px;" >
					</td>
					...
					<td class="td_body">
						<select name="geThirdParterInfo.companyType" style="width:100px">
...
<script type="text/javascript">
	window.onload = function(){
		...
		var contents = ['说明：查询供应商 。<br/>使用人群：配置供应商操作人员 <br/>配置条件：<br/>注意事项：'];
	    	for ( var i = 0 ; i < 10 ; i++ ){
				$('#' + ids[i]).qtip({ 
					content:contents[i], 
					position: { 
	...
	function alterTree(){
		...
		*/
		var authorityid = document.getElementById("authorityid").value;
		var authorityDepartmentManager = document.getElementById("authorityDepartmentManager").value;
		window.open('${ctx}/deptAuthority/DeptAuthIdQuery.do?authorityid=ROLE_B_PTPI_M&type=2&receivedObj='+authorityid+'&receivedObjName='+authorityDepartmentManager,
				'机构' ,'top=100, left=500, width=400,height=500,toolbar=no');
	}
</script>
</html>
