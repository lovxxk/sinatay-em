...
<script language="javascript">
	...
	function doEdit(){
		...
		//window.open("${ctx}/party/prepareUpdateThirdParterInfo.do?geThirdParterInfo.thirdParterID=" + idStr,"编辑用户" ,"top=100, left=100, width=900,height=600,toolbar=yes,scrollbars=auto");
		//,"top=100, left=100, width=1200,height=600,toolbar=no,menubar=no,scrollbars=yes"
		window.open("${ctx}/party/prepareUpdateThirdParterInfo.do?geThirdParterInfo.thirdParterID=" + idStr,"编辑用户","top=100, left=100, width=1100,height=600,toolbar=no,menubar=no,scrollbars=yes");
		//window.open("${ctx}/party/prepareUpdateThirdParterInfo.do?geThirdParterInfo.thirdParterID=" + idStr,"编辑用户");
	...
	function doDelete(){
		...
		if(confirm("确定删除您选中的"+count+"个公司记录吗？")){
			window.parent.frames[4].location.href = "${ctx}/party/deleteThirdParterInfoAndThridParterContact.do?geThirdParterInfo.thirdParterID=" + idStr;
		}
	}
	//特殊处理end
</script>
