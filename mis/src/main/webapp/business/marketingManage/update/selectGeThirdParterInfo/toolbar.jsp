	...
	<div id="toolbar_DIV">
		<table id="toolbar_main" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td onclick="getGeCodeType();" onmouseover="changeTD_style(this);" onmouseout="changeTD_style(this);">关联到供应商</td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
...
<script language="javascript">
	...
	function getGeCodeType(){
		...
		if(confirm("确定关联该供应商?")){
			...
			//top.opener.document.getElementById("codeType").value = idStr;
