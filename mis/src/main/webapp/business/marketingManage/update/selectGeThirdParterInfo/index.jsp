...
<frameset id="fraTop" rows="170,30,*,40,0" border="0" frameborder="no" framespacing="0">
	<frame name="fraSearchForm" src="${ctx}/business/marketingManage/create/selectGeThirdParterInfo/frmSearch.jsp?nameCount=<%=nameCount%>" frameborder="0" scrolling="no" noresize></frame>
