	...
	<div id="toolbar_DIV">
		<table id="toolbar_main" cellpadding="0" cellspacing="0">
			<tr>
				...
				<acc:showView source="ROLE_B_DZMA_E">
					<td onclick="doNoExecute();" onmouseover="changeTD_style(this);" onmouseout="changeTD_style(this);">编辑</td>
				<td>&nbsp;</td>
				</acc:showView>
				<acc:showView source="ROLE_B_DZMA_D">
					<td onclick="doFinish();" onmouseover="changeTD_style(this);" onmouseout="changeTD_style(this);">删除</td>
				<td>&nbsp;</td>
				</acc:showView>
			</tr>
		</table>
...
function doNoExecute(){
	...
	window.open("${ctx}/marketing/findGeDiscountManageForUpdate.do?geDiscountManage.discountid=" + geIdStatus()[0],"编辑用户" ,"top=100, left=100, width=900,height=500,scrollbars");
}
...
function doFinish(){
	...
	if(confirm("确定删除您选中的"+count+"个打折活动吗？")){
		window.parent.frames[4].location.href = "${ctx}/marketing/delGeDiscountManage.do?idStr=" + geIdStatus()[0];
	}
}
