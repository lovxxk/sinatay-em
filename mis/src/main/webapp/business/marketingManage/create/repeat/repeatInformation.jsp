...
<c:when test="${param.type=='create'}"><!-- 新建的时候提示信息 -->
	...
	<c:when test="${flag eq 1}">
		<script language="javascript">
			alert("${message}");
			window.parent.location.href = "${ctx}/business/marketingManage/search/index.jsp";
// 			window.parent.location.href="${ctx}/business/marketingManage/create/repeat/info1.jsp?message=${message}";
