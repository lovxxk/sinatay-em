...
<script language="javascript">
	...
	function getProduct(){
		...
		if (count == 1) {
			var area = valArr[0];
			if (confirm(" 确定添加该产品？")) {
				if(isRepeat(valArr[0])){
					top.opener.document.getElementsByName("coreProductCode")[valArr[2]].value = valArr[0];
					top.opener.document.getElementsByName("coreProductName")[valArr[2]].value = valArr[1];
					top.close();
				}
			}
	...
	function isRepeat(eid){
		var eids = top.opener.document.getElementsByName("coreProductCode");
