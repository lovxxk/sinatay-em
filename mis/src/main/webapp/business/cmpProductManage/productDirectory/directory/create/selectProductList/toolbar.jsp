	...
	<div id="toolbar_DIV">
		<table id="toolbar_main" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td onclick="getProduct();" onmouseover="changeTD_style(this);" onmouseout="changeTD_style(this);">关联到目录</td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
...
<script language="javascript">
	...
	function getProduct(){
		...
		if (count == 1) {
			...
			if (confirm("确定关联该产品?")) {
				if ("car" == area) {
					top.opener.document.getElementById("netSaleProductType").value = "01";
					top.opener.document.getElementById("coreProductCode").value = valArr[1];
					top.opener.document.getElementById("productName").value = valArr[2];
					top.opener.document.getElementById("coreProductSimpleName").value = valArr[2];
					top.opener.document.getElementById("businessAreaSelect").selectedIndex = valArr[3];
					top.opener.document.getElementById("businessArea").value = valArr[3];
				} else if ("onCar" == area) {
					top.opener.document.getElementById("netSaleProductType").value = "02";
					top.opener.document.getElementById("coreProductCode").value = valArr[1];
					top.opener.document.getElementById("productName").value = valArr[2];
					top.opener.document.getElementById("coreProductSimpleName").value = valArr[3];
					top.opener.document.getElementById("businessAreaSelect").selectedIndex = valArr[3];
					top.opener.document.getElementById("businessArea").value = valArr[3];
				} else if("card" == area){
					top.opener.document.getElementById("netSaleProductType").value = "03";
					top.opener.document.getElementById("coreProductCode").value = valArr[1] + "_" + valArr[2];
					top.opener.document.getElementById("productName").value = valArr[3];
					top.opener.document.getElementById("coreProductSimpleName").value = valArr[3];
					top.opener.document.getElementById("businessAreaSelect").selectedIndex = 3;
					top.opener.document.getElementById("businessArea").value = 3;
				}
			}
			top.close();
		} else if (count == 0) {
