...
<script language="javascript">
	...
	function doEdit(){
		...
		window.open("${ctx }/business/customerManage/blacklist/queryGeBlackListForUpdate.do?geBlackList.id=" + idStr,"编辑用户" ,"top=100, left=100, width=900,height=600,toolbar=no");		
	}
