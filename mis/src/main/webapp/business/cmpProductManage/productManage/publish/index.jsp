...
<body topmargin="0" leftmargin="0">
	...
	<div class="table_content">
		...
		<input type="hidden" name="geProductMain.productStatus" value="05">
			...
			<table class="table_style" align="center" width="70%" id="productTable">
				...
				<tr>
					<td class="td_head td_head_center" width="150px" style="text-align: center"  nowrap>
						<font color="#616161">要发布的产品名称：</font>
					</td>
				...
				<tr>
					<td class="td_head td_head_center"  style="text-align: center" nowrap>
						<font color="#616161">要发布的产品编码：</font>
					</td>
				...
				<tr height="140px">
					<td class="td_head td_head_center" width="120px" style="vertical-align: top" nowrap>
						<font color="#616161">处理意见：</font>
					</td>
					<td class="td_body" width="200px"  nowrap>
