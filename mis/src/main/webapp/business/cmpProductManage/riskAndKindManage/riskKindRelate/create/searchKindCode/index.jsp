...
<frameset id="fraTop" rows="170,30,*,40,0" border="0" frameborder="no" framespacing="0">
	<frame name="fraSearchForm" src="${ctx}/business/cmpProductManage/riskAndKindManage/searchKindCode.do?validInd=${param.validInd}" frameborder="0" scrolling="no" noresize></frame>
