...
<head>
	...
	<script src="${ctx}/business/cmpProductManage/riskAndKindManage/kind/create/createGeRelate/searAddKind.js"></script>
	<title>查询附加险</title>
	<style type="text/css">
										...
										<table class="table_style" id="queryProductRuleTable" align="center" width="450px">
											<tr>
												...
												<td class="td_body" width="25%" >
													<input id="paramRiskCode" type="text" value="${param.riskCode}" readonly="readonly" name="geKind.id.riskCode" style="width:120px;" maxlength="4">
												</td>
												<td class="td_head td_head_center" width="10%" nowrap>
													险别代码：
												</td>
												<td class="td_body" width="25%" >
													<input id="cleanKindCode" type="text" name="geKind.id.kindCode" style="width:120px;" maxlength="7">
												</td>
											</tr>
											<tr height="60px;">
