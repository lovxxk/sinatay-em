...
<script language="javascript">
	...
	function doDelete(){
		...
		if(confirm("确定删除您选中的利率吗？")){
			$.ajax({
				url:contextRootPath+"/universal/deleteUniversal.do",
				async:false,
				dataType:"json",
				data:{"riskCode": idStr 
				     },
	...
	//	alert("查看的代码："+idStr);
		window.open("${ctx}/hospital/viewHospital.do?geRisk.riskCode=" + idStr,"查看险种" ,"top=100, left=100, width=900,height=600,toolbar=no");
	}
	function doUpate(){
		if(!getId()){
			return;
