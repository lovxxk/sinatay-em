...
<body topmargin="0" leftmargin="0">
		...
		万能险利率维护<span id="des" style="cursor: pointer;font-size: 15px;"><img style="vertical-align:middle;color:#E9E7E8" src="${ctx}/global/images/help.png"/></span>
	   </div>
		<form id="frmInput" name="frmInput" method="post" action="${ctx}/universal/findUniversal2.do" target="fraSearchList">
			<table class="table_style" style="width:528px;" >
				<tr> 
					...
					<td class="td_body">
						<input id="riskName" type="text" name="universal.riskName" maxlength="50">
					</td>
				</tr>
				<tr height="60px;">
...
<script type="text/javascript">
	function doSearch(){
		...
		$("#riskName").attr("value",$.trim($("#riskName").val())); 
	...
	$(function(){
		...
		var contents = ['说明：万能险利率维护。<br/>使用人群：<br/>配置条件：<br/>注意事项：'];
	    	for ( var i = 0 ; i < 10 ; i++ ){
				$('#' + ids[i]).qtip({ 
					content:contents[i], 
					position: { 
