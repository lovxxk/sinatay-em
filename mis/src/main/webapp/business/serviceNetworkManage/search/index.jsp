...
<frameset id="fraTop" rows="135,30,*,40,0" border="0" frameborder="no" framespacing="0">
	<frame name="fraSearchForm" src="${ctx}/serviceNetwork/findServiceNetwork.do" frameborder="0" scrolling="no" noresize></frame>
