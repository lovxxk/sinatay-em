...
<div style="padding-top:15px;padding-left:15px;width:100%;font-size:14px;font-weight:bold;text-align:left;clear:both;">&gt;&gt;&nbsp;编辑服务网点</div>
	...
	<table class="table_style" width="600px;">
		...
		<tr>
			<td colspan=2>
				...
				<tr>
					<td id="createButton" align=right class="btnBigOnFocus"  onclick="doCreate();" nowrap>修改 </td>
					<td width=5>&nbsp;</td>
