...
.popss_warpper{width:583px; height:376px;background:url(../images/popss_bg.jpg) no-repeat; clear:both;}
.popss_title{clear:both; height:38px; line-height:38px; color:#FFFFFF; padding-left:36px; letter-spacing:8px;}
.popss_news{clear:both; background:url(../images/popss_pic.jpg) no-repeat 175px 92px; padding:144px 0px 100px 261px;}
</style>
</head>
<body>
...
<div style="padding-left:210px;">
	<div class="popss_warpper">
		...
		<div class="popss_news">${param.message}</div>
