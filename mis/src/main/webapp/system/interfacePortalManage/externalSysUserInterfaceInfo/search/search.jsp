...
<body topmargin="2" leftmargin="2">
	<table width="100%" class="table_Show" id="data_table">
		<tr>
			...
			<td class="search_head" nowrap>服务端用户和接口关系主键</td>
			<td class="search_head" nowrap>交易代码</td>
			<td class="search_head" nowrap>交易名称</td>
			<td class="search_head" nowrap>服务端用户逻辑主键</td>
...
function viewExternalSysUserInterfaceInfoDetail(id){
	window.open("${ctx}/interfacePortal/viewExternalSysUserInterfaceInfoDetail.do?externalSysUserInterfaceInfo.id=" + id ,"外部系统用户和接口之间的关系信息详细","top=100, left=100,width=1000,,height=550,toolbar=no,scrollbars=yes");
}
...
function viewInterfaceInfoDetail(transCode){
	window.open("${ctx}/interfacePortal/viewInterfaceInfoDetail.do?interfaceInfo.transCode=" + transCode ,"接口信息详细","top=100, left=100,width=1000,,height=700,toolbar=no,scrollbars=yes");
}
</script>
