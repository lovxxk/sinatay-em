...
<head>
	...
	<title>电子商务管理系统-交易报文维护</title>
</head>
<body topmargin="0" leftmargin="0">
	<div class="public_fun_title">交易报文维护</div>
	<div class="table_content">
		<form id="frmInput" name="frmInput" method="post" action="${ctx}/interfacePortal/searchTransactionMessagePage.do" target="fraSearchList">
			<table class="table_style" align="center" width="720px">
				<tr>
					...
					<td class="td_body">
						<input type="text" id="transRefGuid" name="transactionMessage.transRefGuid" maxlength="50" style="width:170px;">
					</td>
					<td class="td_head" width="120" nowrap>
						交易代码：
					</td>
					<td class="td_body">
						<input type="text" id="transCode" name="transactionMessage.transCode" maxlength="50" style="width:170px;">
					</td>
				</tr>
				<tr>
					<td class="td_head" width="120" nowrap>
