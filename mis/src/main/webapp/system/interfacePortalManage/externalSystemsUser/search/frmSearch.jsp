...
<head>
	...
	<title>电子商务管理系统-服务器端用户信息维护</title>
</head>
<body topmargin="0" leftmargin="0">
	<div class="public_fun_title">服务器端用户信息维护</div>
	<div class="table_content">
		<form id="frmInput" name="frmInput" method="post" action="${ctx}/interfacePortal/searchExternalSystemsUserPage.do" target="fraSearchList">
