...
<form action="${ctx}/authorityManage/createOnlineEnterpriseAuthority.do" method="post" id="frmInput" target="myFrame">
	...
	<table  border=0 style="font-size:9pt;width:400px"  cellpadding=0 cellspacing=0 align="center">
		<tr>
			...
			<td class="td_body" nowrap>
				<input id="authorityID" name="geEnterpriseAuthority.authorityID" type="text" value="ROLE_" style="width:170px;" maxlength=50>
			</td>
		</tr>
		<tr>
			<td class="td_head" nowrap>权限名称：</td>
			<td  class="td_body" nowrap>
				<input name="geEnterpriseAuthority.authorityName" type="text" style="width:170px;" maxlength=50>
			</td>
		</tr>
		<tr>
		...
		<tr id="linkTr" style="display:none;">
			...
			<td  class="td_body" nowrap>
				<textarea id="authorityLink" name="geEnterpriseAuthority.authorityLink" style="width:300px;height:50px;"></textarea>
			</td>
		</tr>
		<tr>
			<td class="td_head" nowrap>权限描述：</td>
			<td  class="td_body" nowrap>
				<input name="geEnterpriseAuthority.authorityDesp" type="text" style="width:170px;" maxlength=100/>
			</td>
		</tr>
		<tr>
			<td class="td_head" nowrap>权限序号：</td>
			<td  class="td_body" nowrap>
				<input name="geEnterpriseAuthority.authorityorder" type="text" style="width:170px;" maxlength=10/>
			</td>
		</tr>
		<tr>
			<td class="td_head" nowrap>权限层级：</td>
			<td  class="td_body" nowrap>
				<input name="geEnterpriseAuthority.authorityLevel" value="${geEnterpriseAuthority.authorityLevel}" style="width:170px;" maxlength=10/>
			</td>
		</tr>
		<tr height="60px">
			<td colspan=2>
...
function pageValidate(){
	tt.vf.req.add("geEnterpriseAuthority.authorityID","geEnterpriseAuthority.authorityName","geEnterpriseAuthority.authorityType");
	tt.vf.num.add("geAuthority.authorityorder");
	new tt.RV().set(new RegExp("^ROLE_.+$"), "必须以ROLE_开头").add("geEnterpriseAuthority.authorityID"); 
}
function showLink(){
