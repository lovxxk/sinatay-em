...
<div class="public_fun_title">前台企业等级权限维护<span id="des" style="cursor: pointer;font-size: 15px;"><img style="vertical-align: middle;color:#E9E7E8" src="/mis/global/images/help.png"/></span></div>
	<div class="table_content">
		<form id="frmInput" name="frmInput" method="post" action="${ctx}/authorityManage/searchEnterpriseGePersonalLevel.do" target="fraSearchList">
...
$(document).ready(function(){
	//pop提示信息
    	var ids = ['des'];
    	var contents = ['说明：维护前台企业功能等级权限<br/>使用人群：权限管理人员<br/>配置条件：<br/>注意事项：用户等级只能进行精确查询'];
        	for ( var i = 0 ; i < 1 ; i++ ){
    			$('#' + ids[i]).qtip({ 
    				content:contents[i], 
    				position: { 
