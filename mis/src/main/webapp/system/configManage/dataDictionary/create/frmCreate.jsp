...
<tr>
	...
	<td class="td_body" width="500px">
		...
		<input type="button" style="width:80px" onclick="getGeCodeType();" value="获取类型…"/>
	</td>
</tr>
<tr>
...
function getGeCodeType(){
	window.open("${ctx}/system/configManage/dataDictionary/create/selectType/index.jsp","查询产品" ,"top=100, left=100, width=900,height=600,toolbar=no");		
}
