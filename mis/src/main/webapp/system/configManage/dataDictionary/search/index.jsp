...
<frameset id="fraTop" rows="170,30,*,60,0" border="0" frameborder="no" framespacing="0">
	<frame name="fraSearchForm" src="<%=request.getContextPath()%>/business/businessManage/dataDictionary/frmSearchTypeSon.do" frameborder="0" scrolling="no" noresize></frame>
