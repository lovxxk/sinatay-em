...
<form id="frmInput" name="frmInput" method="post" action="${ctx}/business/businessManage/serviceNetwork/findServiceNetworkForOperate.do" target="fraSearchList">
	<div class="table_content">
		<input type="hidden" value="${param.deptid}" name="geStationInfo.deptid">
			<table align="left" width="300px">
				<tr valign="middle">
					...
					<td class="td_body" width="18%" >
						<input name="geStationInfo.unitName"  style="width:170px;">
					</td>
