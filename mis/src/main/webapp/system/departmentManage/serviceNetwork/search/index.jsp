...
<div class="public_fun_title">机构网点配置</div>
<div style="height:10px;clear:both;">&nbsp;</div>
<table id="kuang" class="frmCreate_kuang" style="width:98%;height:75%;" align="center" cellspacing="0" cellpadding="0">
	<tr>
		<td class="frmCreate_kuang_header" style="border-right:1px solid #dcdcdc;width:250px;text-align:center;">服务网点维护</td>
		<td class="frmCreate_kuang_header" style="text-align:center;">服务网点操作</td>
	</tr>
	<tr>
		<td style="border-right:1px solid #dcdcdc;padding:0px;margin:0px;width:55%" valign="top">
			...
			<iframe style="width:100%;height: 30px;" frameborder="0" name="fraToolbar" src="toolbar.jsp?deptid=${param.deptid}&city=${param.city}&cityName=${param.cityName}&province=${param.province}&provinceName=${param.provinceName}" frameborder="0" scrolling="no" noresize></iframe>
		...
		<td width="45%">
			<iframe name="operate" style="height:95%;width:100%;" frameborder="0" scrolling="no" id="operate" src="${ctx}/system/departmentManage/serviceNetwork/create/frmCreate.jsp?deptid=${param.deptid}&city=${param.city}&cityName=${param.cityName}&province=${param.province}&provinceName=${param.provinceName}"></iframe>
		</td>
	</tr>
</table>
</body>
