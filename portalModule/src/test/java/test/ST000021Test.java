...
public class ST000021Test {
	...
	public static void main(String[] args) {
		...
		String mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST000021_Req_CastorMapping.xml";
		...
		mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST000021_Res_CastorMapping.xml";
...
//			risk2.getAccounts().add(riskAccount);
	...
	public static String ST000021ResMarshller(){
		StringWriter sw = new StringWriter();
		Date transDate = new Date();
		String mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST000021_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
