...
public class ST010001Test {
	...
	public static void main(String[] args) {
		String s = ST010001ReqMarshller();
		System.out.println("身份证校验请求...");
		System.out.println(s);
		String mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST010001_Req_CastorMapping.xml";
		TXInsurance txi = (TXInsurance)ST010001UnMarshall(mappingFilePath,s);
		systemObject(txi);
		...
		System.out.println("*********");
		String s1 = ST010001ResMarshller();
		System.out.println("身份证校验应答...");
		System.out.println(s1);
		mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST010001_Res_CastorMapping.xml";
		TXInsurance txi1 = (TXInsurance)ST010001UnMarshall(mappingFilePath,s1);
		systemObject(txi1);
	}
	...
	public static String ST010001ReqMarshller(){
		...
		try {
			...
			txInsurance.setTransType("ST010001");
...
//			txInsurance.setTellerNo(serialNumber.substring(serialNumber.length()-6,serialNumber.length()));
			...
			idCardCheck.setGmsfhm("370921198605231516");
			idCardCheck.setFsd("330226");
			idCardCheck.setXm("刘晨");
			idCardCheck.setYwlx("WEB");
	...
	public static String ST010001ResMarshller(){
		StringWriter sw = new StringWriter();
		Date transDate = new Date();
		String mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST010001_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
			...
			IdCardCheckResult item = new IdCardCheckResult();
			IdCardCheckResult item1 = new IdCardCheckResult();
			IdCardCheckResult item2 = new IdCardCheckResult();
			
			idCardCheck.getItems().add(item);
			idCardCheck.getItems().add(item1);
			idCardCheck.getItems().add(item2);
			
			tranResponse.getIdCardChecks().add(idCardCheck);
	...
	public static Object ST010001UnMarshall(String mappingFilePath, String xmlString){
