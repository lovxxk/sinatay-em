...
public class T000021Test_00136000_00136400 {
...
//			lcCont.setDisputedFlag("1");
			...
			//险种
			Risk risk = new Risk();
			risk.setMainRiskCode("00136100");
			risk.setRiskCode("00136100");
			risk.setAmnt(new BigDecimal(100000));
//			risk.setPrem(new BigDecimal(3.75));
			risk.setMult(1);
//			risk.setPayIntv("12");
