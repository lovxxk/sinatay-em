...
public class ST000029Test {
	...
	/**
	 * @param args
	 * 保单明细查询(ST000029)请求、应答Test
	 * @throws Exception 
	 */
	public static void main(String[] args) throws Exception {
//		invokeWebService();
		String s = ST000029ReqMarshller();
		System.out.println("保单明细查询(ST000029)请求...");
...
//			System.out.println(sc.sendRequestXML(requestURL, s, charset));
		...
		System.out.println("保单明细查询(ST000029)应答...");
...
//	    System.out.println("大黄蜂请求...");
		System.out.println("大黄蜂保单明细查询(ST000029)请求...");
		System.out.println(requestXML);
		...
		System.out.println("大黄蜂保单明细查询(ST000029)应答...");
