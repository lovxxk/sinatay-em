...
//		invokeWebService();
		...
		String mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000025_Service_Default_Req_CastorMapping.xml";
...
//			System.out.println(sc.sendRequestXML(requestURL, s, charset));
		...
		mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000025_Service_Default_Res_CastorMapping.xml";
...
//	    System.out.println("大黄蜂请求...");
	...
	public static String ST000025ResMarshller(){
		...
		Date transDate = new Date();
		String serialNumber = GeneratorTransSerialNumber.generatorTransSerialNumberyyyyMMddHHmmss();
		String mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000025_Service_Default_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
			txInsurance.setTransRefGUID("TBJ"+serialNumber);
			txInsurance.setTransType("ST000025");
