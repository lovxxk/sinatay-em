...
public class ST000021Test {

	/**
	 * @param args
	 * 在线试算(ST000021)请求、应答Test
	 */
	public static void main(String[] args) {
		String s = ST000021ReqMarshller();
		System.out.println("在线试算(ST000021)请求...");
		System.out.println(s);
		String mappingFilePath = "E:/e_workdir/ClearCase/liuchen_em__dzsw/dzsw_pro/mall/portalModule/src/main/resources/castorMappingFile/subService/ST000021_Req_CastorMapping.xml";
		TXInsurance txi = (TXInsurance)ST000021UnMarshall(mappingFilePath,s);
		systemObject(txi);
		...
		System.out.println("*********");
		String s1 = ST000021ResMarshller();
		System.out.println("在线试算(ST000021)应答...");
		System.out.println(s1);
		mappingFilePath = "E:/e_workdir/ClearCase/liuchen_em__dzsw/dzsw_pro/mall/portalModule/src/main/resources/castorMappingFile/subService/ST000021_Res_CastorMapping.xml";
		TXInsurance txi1 = (TXInsurance)ST000021UnMarshall(mappingFilePath,s1);
		systemObject(txi1);
	}
	...
	public static String ST000021ReqMarshller(){
		...
		try {
			...
			txInsurance.setTransType("ST000021");
...
//			lcInsured.getRisks().add(risk2);
	...
	public static String ST000021ResMarshller(){
		StringWriter sw = new StringWriter();
		Date transDate = new Date();
		String mappingFilePath = "E:/e_workdir/ClearCase/liuchen_em__dzsw/dzsw_pro/mall/portalModule/src/main/resources/castorMappingFile/subService/ST000021_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
	...
	public static Object ST000021UnMarshall(String mappingFilePath, String xmlString){
