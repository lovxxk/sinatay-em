...
public class ST000095Test {
	...
	/**
	 * @param args
	 * 日终对账(ST000095)请求、应答Test
	 * @throws Exception 
	 */
	public static void main(String[] args) throws Exception {
//		invokeWebService();
		String s = ST000095ReqMarshller();
		System.out.println("日终对账(ST000095)请求...");
		System.out.println(s);
		String mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000095_Service_Default_Req_CastorMapping.xml";
...
//			System.out.println(sc.sendRequestXML(requestURL, s, charset));
		...
		System.out.println("日终对账(ST000095)应答...");
		System.out.println(s1);
		mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000095_Service_Default_Res_CastorMapping.xml";
...
//		requestXML = "<?xml version=\"1.0\" encoding=\"GBK\"?><TranData><BaseInfo><TransrDate>20131213</TransrDate><TransrTime>18:56:53</TransrTime><TellerNo>0001</TellerNo><TransrNo>DHF20131213000000106</TransrNo><SaleChannel>W</SaleChannel><SellType>20</SellType><FunctionFlag>ST000095</FunctionFlag><Source>DHF</Source></BaseInfo><TranRequest><QueryData><PageNo>1</PageNo><PageRowNum>50</PageRowNum><QueryType>04</QueryType><Params><ParamCount>1</ParamCount><Param><Key>ProposalContNo</Key><Value>340110000000055</Value></Param></Params></QueryData></TranRequest></TranData>";
//	    System.out.println("请求...");
	...
	public static String ST000095ResMarshller(){
		...
		Date transDate = new Date();
		String serialNumber = GeneratorTransSerialNumber.generatorTransSerialNumberyyyyMMddHHmmss();
		String mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000095_Service_Default_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
			txInsurance.setTransRefGUID("TBJ"+serialNumber);
			txInsurance.setTransType("ST000095");
