...
public class ST000039Test {

	/**
	 * @param args
	 * 退保确定(ST000039)请求、应答Test
	 * @throws Exception 
	 */
	public static void main(String[] args) throws Exception {
//		invokeWebService();
		String s = ST000039ReqMarshller();
		System.out.println("退保确定(ST000039)请求...");
		System.out.println(s);
		String mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000039_Service_Default_Req_CastorMapping.xml";
		TXInsurance txi = (TXInsurance)ST000039UnMarshall(mappingFilePath,s);
		systemObject(txi);
...
//			System.out.println(sc.sendRequestXML(requestURL, s, charset));
		...
		System.out.println("*********");
		String s1 = ST000039ResMarshller();
		System.out.println("退保确定(ST000039)应答...");
		System.out.println(s1);
		mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000039_Service_Default_Res_CastorMapping.xml";
		TXInsurance txi1 = (TXInsurance)ST000039UnMarshall(mappingFilePath,s1);
		systemObject(txi1);
	}
	
	public static void invokeWebService() throws Exception{
		String requestXML = ST000039ReqMarshller();
//		System.out.println(requestXML);
//		requestXML = "<?xml version=\"1.0\" encoding=\"GBK\"?><TranData><BaseInfo><TransrDate>20131213</TransrDate><TransrTime>18:56:53</TransrTime><TellerNo>0001</TellerNo><TransrNo>DHF20131213000000106</TransrNo><SaleChannel>W</SaleChannel><SellType>20</SellType><FunctionFlag>ST000039</FunctionFlag><Source>DHF</Source></BaseInfo><TranRequest><QueryData><PageNo>1</PageNo><PageRowNum>50</PageRowNum><QueryType>04</QueryType><Params><ParamCount>1</ParamCount><Param><Key>ProposalContNo</Key><Value>340110000000055</Value></Param></Params></QueryData></TranRequest></TranData>";
//	    System.out.println("请求...");
	...
	public static String ST000039ReqMarshller(){
		...
		try {
			...
			txInsurance.setTransType("ST000039");
	...
	public static String ST000039ResMarshller(){
		StringWriter sw = new StringWriter();
		Date transDate = new Date();
		String serialNumber = GeneratorTransSerialNumber.generatorTransSerialNumberyyyyMMddHHmmss();
		String mappingFilePath = "E:/e_workdir/git/sinatay-em/portalModule/src/main/resources/castorMappingFile/service/ST000039_Service_Default_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
			txInsurance.setTransRefGUID("TBJ"+serialNumber);
			txInsurance.setTransType("ST000039");
	...
	public static Object ST000039UnMarshall(String mappingFilePath, String xmlString){
