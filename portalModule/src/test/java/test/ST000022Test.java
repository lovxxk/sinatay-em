...
public class ST000022Test {
	...
	public static void main(String[] args) {
		...
		String mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST000022_Req_CastorMapping.xml";
		...
		System.out.println("在线试算(ST000022)、在线核保（ST000022）应答...");
		System.out.println(s1);
		mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST000022_Res_CastorMapping.xml";
...
//			lcInsured.getRisks().add(risk2);
	...
	public static String ST000022ResMarshller(){
		StringWriter sw = new StringWriter();
		Date transDate = new Date();
		String mappingFilePath = "E:/workdir/workspace_37_sinatay/portalModule/src/main/resources/castorMappingFile/ST000022_Res_CastorMapping.xml";
		try {
			TXInsurance txInsurance = new TXInsurance();
