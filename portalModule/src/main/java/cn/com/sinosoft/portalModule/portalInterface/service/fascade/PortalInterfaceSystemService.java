...
public interface PortalInterfaceSystemService {
	 ...
	 * @return
	 */
	public abstract void addPortalInterfaceSystem(
			PortalInterfaceSystem portalInterfaceSystem);
	 ...
	 */
	public abstract Page findPortalInterfaceSystem(QueryRule queryRule,
			int pageNo, int pageSize);

	public abstract void deletePortalInterfaceSystem(
			PortalInterfaceSystem portalInterfaceSystem);
	 ...
	 */
	public abstract void updatePortalInterfaceSystem(
			PortalInterfaceSystem portalInterfaceSystem);
