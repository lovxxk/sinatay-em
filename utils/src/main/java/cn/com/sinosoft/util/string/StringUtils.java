 ...
 */
package cn.com.sinosoft.util.string;
...
import cn.com.sinosoft.lang.ArrayUtils;
import cn.com.sinosoft.lang.CharSetUtils;
import cn.com.sinosoft.lang.CharUtils;
import cn.com.sinosoft.lang.ObjectUtils;
import cn.com.sinosoft.lang.StringEscapeUtils;
import cn.com.sinosoft.lang.WordUtils;
...
public class StringUtils {
     ...
     * @return
     */
    public static String upperPointCase(String str, int point) {
    	...
    	char pointChar = str.charAt(point);
    	if (pointChar >= 'a' && pointChar <= 'z') {
    		pointChar = (char)(pointChar - 32); 
    		;
    	}
        return str.substring(0, point) + pointChar + str.substring(point + 1) ;
    }
     ...
     * @return
     */
    public static String lowerPointCase(String str, int point) {
