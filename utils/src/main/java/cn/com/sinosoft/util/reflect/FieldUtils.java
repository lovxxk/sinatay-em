 ...
 */
package cn.com.sinosoft.util.reflect;
...
public class FieldUtils {
    ...
    public static List<String> getAllDeclaredFieldName(Class cls) {
    	Field[] declaredFields = cls.getDeclaredFields();
    	List<String> allDeclaredFieldName= new ArrayList<String>();
    	for (int i = 0 ; i < declaredFields.length; i++) {
    		Field field = declaredFields[i];
    		allDeclaredFieldName.add(field.getName());
    	}
        return allDeclaredFieldName;
    }
    /**
