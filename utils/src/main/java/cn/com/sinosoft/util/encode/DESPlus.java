...
public class DESPlus {
	...
	public static void main(String[] args) {
		try {
			String test ="0000000086841688";
			
			// DESPlus des = new DESPlus();//默认密钥
			DESPlus des = new DESPlus("sclf1798");// 自定义密钥
			System.out.println("加密前的字符：" + test);
			
			String desValue=des.encrypt(test);
			System.out.println("加密后的字符：" + desValue);
			
			System.out.println("解密后的字符：" + des.decrypt(desValue));
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
