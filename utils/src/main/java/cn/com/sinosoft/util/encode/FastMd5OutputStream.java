...
/**
 * FastMd5OutputStream is a subclass of FilterOutputStream adding FastMd5
...
public class FastMd5OutputStream extends FilterOutputStream {
	/**
	 * FastMd5 context
	 */
	private FastMd5 md5;
	...
	/**
	 * Creates FastMd5OutputStream
	 * 
	 * @param out
	 *            The output stream
	 */

	public FastMd5OutputStream(OutputStream out) {
		super(out);
	...
	public static void main(String[] arg) {
		try {
			FastMd5OutputStream out = new FastMd5OutputStream(new cn.com.sinosoft.util.io.NullOutputStream());
