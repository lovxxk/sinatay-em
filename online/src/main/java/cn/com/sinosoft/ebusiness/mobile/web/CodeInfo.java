...
public class CodeInfo {
	...
	public final static List<LDCode> provinces = new ArrayList<LDCode>();
	
	public final static List<LDCode> cities = new ArrayList<LDCode>();
	
	public final static List<LDCode> counties = new ArrayList<LDCode>();
	
	public final static List<LDCode> banks = new ArrayList<LDCode>();
	...
	private static void init1() {
		...
		for (int i = 0; i < length; i++) {
			...
			ldCode.setCode(addresses[i][0]);
			ldCode.setCodeName(addresses[i][1]);
			ldCode.setOtherSign(addresses[i][3]);
			if ("1".equals(addresses[i][2])) {
				provinces.add(ldCode);
			} else if ("2".equals(addresses[i][2])) {
				cities.add(ldCode);
			} else if ("3".equals(addresses[i][2])) {
				counties.add(ldCode);
			}
	...
	private static void init3() {
		String[][] addresses = new String[][] {
				...
				{"469031","西沙群岛","3","469000"},
				{"469032","南沙群岛","3","469000"},
				{"469033","中沙群岛的岛礁及其海域","3","469000"},
				{"500100","市辖区","2","500000"},
				{"500101","万州区","3","500100"},
				{"500102","涪陵区","3","500100"},
				{"500103","渝中区","3","500100"},
	...
	private static void init4() {
		String[][] addresses = new String[][] {
				...
				{"710701","东区","3","710700"},
				{"710702","西区","3","710700"},
				{"710800","台北县(板桥市)","2","710000"},
				{"710801","台北县(板桥市)","3","710800"},
				{"710900","宜兰县(宜兰市)","2","710000"},
				{"710901","宜兰县(宜兰市)","3","710900"},
				{"711000","新竹县(竹北市)","2","710000"},
				{"711001","新竹县(竹北市)","3","711000"},
				{"711100","桃园县(桃园市)","2","710000"},
				{"711101","桃园县(桃园市)","3","711100"},
				{"711200","苗栗县(苗栗市)","2","710000"},
				{"711201","苗栗县(苗栗市)","3","711200"},
				{"711300","台中县(丰原市)","2","710000"},
				{"711301","台中县(丰原市)","3","711300"},
				{"711400","彰化县(彰化市)","2","710000"},
				{"711401","彰化县(彰化市)","3","711400"},
				{"711500","南投县(南投市)","2","710000"},
				{"711501","南投县(南投市)","3","711500"},
				{"711600","嘉义县(太保市)","2","710000"},
				{"711601","嘉义县(太保市)","3","711600"},
				{"711700","云林县(斗六市)","2","710000"},
				{"711701","云林县(斗六市)","3","711700"},
				{"711800","台南县(新营市)","2","710000"},
				{"711801","台南县(新营市)","3","711800"},
				{"711900","高雄县(凤山市)","2","710000"},
				{"711901","高雄县(凤山市)","3","711900"},
				{"712000","屏东县(屏东市)","2","710000"},
				{"712001","屏东县(屏东市)","3","712000"},
				{"712100","台东县(台东市)","2","710000"},
				{"712101","台东县(台东市)","3","712100"},
				{"712200","花莲县(花莲市)","2","710000"},
				{"712201","花莲县(花莲市)","3","712200"},
				{"712300","澎湖县(马公市)","2","710000"},
				{"712301","澎湖县(马公市)","3","712300"},
				{"810100","市辖区","2","810000"},
				{"810101","中西区","3","810100"},
				{"810102","东区","3","810100"},
				{"810103","九龙城区","3","810100"},
				{"810104","观塘区","3","810100"},
				{"810105","南区","3","810100"},
				{"810106","深水埗区","3","810100"},
				{"810107","黄大仙区","3","810100"},
				{"810108","湾仔区","3","810100"},
				{"810109","油尖旺区","3","810100"},
				{"810110","离岛区","3","810100"},
				{"810111","葵青区","3","810100"},
				{"810112","北区","3","810100"},
				{"810113","西贡区","3","810100"},
	...
	private static void initBank() {
		String[][] intiBanks = new String[][] {
				...
				{"102","工商银行"},
				{"403","中国邮政储蓄银行"} };
		int length = intiBanks.length;
		for (int i = 0; i < length; i++) {
			LDCode ldCode = new LDCode();
			ldCode.setCode(intiBanks[i][0]);
			ldCode.setCodeName(intiBanks[i][1]);
			banks.add(ldCode);
		}
	}
	
	public static void main(String[] args) {
		for (LDCode province : CodeInfo.cities) {
			System.out.print("\"" + province.getCode() + "\", ");
		}
	}
}
