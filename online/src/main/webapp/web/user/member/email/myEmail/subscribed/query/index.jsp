...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="${ctx}/resources/css/user/my_email_subscribed_query.css" rel="stylesheet" type="text/css"/>
		<script src="${ctx}/resources/js/user/my_email_subscribed_query.js" type="text/javascript"></script>
	...
	<body>
		...
		<script type="text/javascript">
			_ga.push(['_trackPageview','/web/user/member/email/myEmail/subscribed/query']).send();
			_hm.push(['_trackPageview','/web/user/member/email/myEmail/subscribed/query']).send();
		</script>
	</body>
</html>
