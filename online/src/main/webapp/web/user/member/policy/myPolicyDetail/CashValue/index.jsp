...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="${ctx}/resources/css/user/cash_value.css" rel="stylesheet" type="text/css"/>
		
	</head>
	<body>
		<jsp:include page="/header.jsp"></jsp:include>
		<jsp:include page="CashValue.jsp"></jsp:include>
		<jsp:include page="/footer.jsp"></jsp:include>
		<!-- 插码 -->
		<script type="text/javascript">
			_ga.push(['_trackPageview','/web/user/member/policy/myPolicyDetail/CashValue']).send();
			_hm.push(['_trackPageview','/web/user/member/policy/myPolicyDetail/CashValue']).send();
		</script>
	</body>
</html>
