...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<jsp:include page="financialTipBook.jsp"></jsp:include>
		<jsp:include page="/footer.jsp"></jsp:include>
		<!-- 插码 -->
		<script type="text/javascript">
			_ga.push(['_trackPageview','/web/common/financialTipBook']).send();
			_hm.push(['_trackPageview','/web/common/financialTipBook']).send();
		</script>
	</body>
</html>
<script>
