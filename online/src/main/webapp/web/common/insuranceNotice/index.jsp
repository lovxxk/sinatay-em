...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<jsp:include page="insuranceNotice.jsp"></jsp:include>
		<jsp:include page="/footer.jsp"></jsp:include>
		<!-- 插码 -->
		<script type="text/javascript">
			_ga.push(['_trackPageview','/web/common/insuranceNotice']).send();
			_hm.push(['_trackPageview','/web/common/insuranceNotice']).send();
		</script>
	</body>
</html>
<script>
