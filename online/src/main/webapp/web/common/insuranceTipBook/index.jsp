...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<jsp:include page="insuranceTipBook.jsp"></jsp:include>
		<jsp:include page="/footer.jsp"></jsp:include>
		<!-- 插码 -->
		<script type="text/javascript">
			_ga.push(['_trackPageview','/web/common/insuranceTipBook']).send();
			_hm.push(['_trackPageview','/web/common/insuranceTipBook']).send();
		</script>
	</body>
</html>
<script>
