function _hm_send(_id, _dm) {
    ...
    function na(a) {
        try {
            ...
            a.l && a.l();
            if (c.rec || c.trust)
                a.a.nv ? (a.g = encodeURIComponent(document.referrer), window.sessionStorage ? s("Hm_from_" + c.id, a.g) : G("Hm_from_" + c.id, a.g, 864E5)) : a.g = (window.sessionStorage ? z("Hm_from_" + c.id) : aa("Hm_from_" + c.id)) || "";
            a.n && a.n();
            a.o && a.o();
            a.e = new va;
...
var _HM = function(_setAccount){
	this.map = new _Map();
	this.map.put('_setAutoPageview', false);
    ...
    this.send = function(autoFlush){
    	_hmt = this.map.toArray();
    	_hm_send(_setAccount, "127.0.0.1:8082/online");
