...
<div  align="center">
	...
	<div class="prompt_popup_wapper">
	    ...
	    <div class="prompt_popup_news1" style="float: left;height: 60px;margin-top: -30px;">
	    	<label id="prompt_popup_news1_label"></label>
	    	<br/>
	    	<br/>
	    	<br/>
	    	<br/>
	    	...
	    	<div>
				...
				onmouseout="this.className='btnBigOnBlur'"  onclick="reBack();">返回创建</td>
					</tr>
				</table>
	    	</div>
	    </div>
...
var msg = decodeURIComponent(window.location.search);
msg = msg.substring(1,msg.length);
document.getElementById("prompt_popup_news1_label").innerHTML = msg.split("=")[1];
function reBack(){
