/**
 * $Id: editor_template_src.js,v 1.1 2010/07/16 05:43:50 yangmuyuan Exp $
 *
 * @author Moxiecode
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_fonts : "ËÎÌå=ËÎÌå;·½ÕýÒ¦Ìå=·½ÕýÒ¦Ìå;ºÚÌå=ºÚÌå;·ÂËÎ_BG2312=·ÂËÎ_BG2312=;¿¬Ìå_GBK=¿¬Ìå_GBK;Á¥Êé=Á¥Êé;Andales Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
...
*/
		...
		_mceCodeEditor : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : parseInt(ed.getParam("theme_advanced_source_editor_width", 420)),
				height : parseInt(ed.getParam("theme_advanced_source_editor_height", 420)),
				inline : true,
				resizable : true,
				maximizable : true
			}, {
