...
function doDelete(){
	...
	//alert(IDStr);
	IDArray=IDStr.split(",");	
	if (confirm("删除选中的" + window.IDCount.value + "篇文章?")){
		window.parent.fraHIDDEN.location.href="${ctx}/articleManage/toDeleteArticle.do?ID="+IDStr;
	}
}
...
<tr align=center>
	...
	<td id="tabindex2" tabindex="2" width=75 onmouseover="this.className='toolbarOnFocus'" onmouseout="this.className='toolbarOnBlur'" onclick="javascript:doDelete();" class="toolbarOnBlur" nowrap>删除</td>
