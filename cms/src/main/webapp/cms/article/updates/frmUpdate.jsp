...
function submitContent(){
	document.getElementById("fraMain").action = "${ctx}/articleManage/toUpdateEdit.do?ID=${ID}";
...
<s:form  id="fraMain" method="post" action="toUploadeImage" target="getAPFrame" width="100%" height="100%" border="0" enctype="multipart/form-data">
	<table border=0 width=879 cellpadding=0 cellspacing=0>
		<tr>
			<td style="BACKGROUND: url(${ctx}/cms/global/images/cms_tc_top_bg.jpg);font-size:13px;color:#4a4c4b;font-weight:bold;" width=135 height=36 valign="top">&nbsp;&nbsp;<img src="${ctx}/cms/global/images/cms_tc_top_ico.jpg"/>&nbsp;&nbsp;文章更新</td>
			...
			<td colspan=3 style="BACKGROUND: url(${ctx}/cms/global/images/cms_tc_foot_bg.jpg) repeat-x bottom;vertical-align:top;" height=670 align=center>
				<table border=0 width=870 cellpadding=0 cellspacing=0 class="table_Show">
					<tr>
						...
						<input value="${docTitle }" type=text name=docTitle maxlength=100 />
						</td>
						<td width=2 nowrap></td>
						...
						<td class="td_in2" width=198 align="left">&nbsp;
							...
							<input value="${channelDesName}" type=text name="docChannelName" readonly />
							<input value="" type=hidden name="docChannel" id="docChannel" />
							<input value="" type=hidden name="tmpDocId" id="tmpDocId" />
				...
				<table width=870 height=520 cellspacing=0 cellpadding=0 border=0 align=center>
					<tr>
						...
						<iframe src="${ctx}/articleManage/updateDocContent.do?tag=update&ID=${ID }" id="framContent" name="framContent" width="700" height="520" scrolling="no"  frameborder="0"></iframe>
						</td>
						<td width=5></td>
						<td>
							<table width=141 height=460 cellspacing=0 cellpadding=0 border=0 align=center>
								...
								<tr>
									<td height=30>
										<textarea rows="10" cols="15" name="docKeysword">${docKeyWord}</textarea>
									</td>
								</tr>
								<tr>
									<td height=20></td>
								...
								<tr>
									<td height=30>
										<input id="d12" type="text" name="docreltime" size="11"  value="${docRelTime }" readonly/>
				...
				<table width=870 height=63 cellspacing=0 cellpadding=0 border=0 align=center>
					<tr>
						...
						<td width=130 height=50>
							<table>
								<tr>
									<td class="btn_ord2"  onclick="doEnclosure('update');">&nbsp;&nbsp;修改</td>
								</tr>
							</table>
						</td>
						<td width=10></td>
