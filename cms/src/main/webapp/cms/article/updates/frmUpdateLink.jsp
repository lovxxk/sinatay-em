...
function submitContent(){
	document.getElementById("fraMain").action = "${ctx}/articleManage/toUpdateLink.do?ID=${ID}";
				...
				<table border=0 width=870 cellpadding=0 cellspacing=0 class="table_Show">
					<tr>
						...
						<td class="td_in2"  align="left">&nbsp;
							<input value="${docTitle }" type=text name=docTitle maxlength=100 /></td>
						<td width=2 nowrap></td>
					...
					<tr>
						...
						<td nowrap></td>
						<td class="td_in2" align="left">&nbsp;
							<input value="${docLink }" type=text name="docLink" maxlength=500 />
						</td>
					...
					<tr>
						...
						<td nowrap></td>
						<td class="td_in2" align="left">&nbsp;
							<input type="text" name="docKeysword" value="${docKeyWord }" maxlength=200 />
						</td>
						<td nowrap></td>
						<td class="td_in1" nowrap height=40>文章撰写时间</td>
						<td nowrap></td>
						<td class="td_in2" align="left">&nbsp;
							<input id="d12" type="text" name="docreltime" value="${docRelTime }" readonly/>
...
<iframe id="a" name="a" src="${ctx}/cms/article/edit/enclosure.jsp?tmpDocId=${ID }" height=0 width=0></iframe>
</body>
</html>
