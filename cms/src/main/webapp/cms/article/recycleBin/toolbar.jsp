...
<table id="toolTable" cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size:9pt;" background="../../global/images/toolbar_bg.jpg">
	<tr align=center>
		...
		<td id="tabindex2" tabindex="2" width=75 onmouseover="this.className='toolbarOnFocus'" onmouseout="this.className='toolbarOnBlur'" onclick="javascript:doRestore();" class="toolbarOnBlur" nowrap>还原</td>
		<td width=8><img src="../../global/images/right_top_se.jpg"></td>
