...
/**
 * POJO类GeUserAuthority
 */
@Entity
@Table(name = "GE_USER_AUTHORITY")
public class GeUserAuthority implements java.io.Serializable {
	...
	/**
	 * 类GeUserAuthority的默认构造方法
	 */
	public GeUserAuthority() {
	}
